...
// in presto_cli/test/file_manager/file_manager_test.dart.
...
class MockIFileFactory extends _i1.Mock implements _i3.IFileFactory {
  MockIFileFactory() {
...
///
/// See the documentation for Mockito's code generation for more information.
class MockIYamlWrapper extends _i1.Mock implements _i3.IYamlWrapper {
  MockIYamlWrapper() {
    _i1.throwOnMissingStub(this);
  }
...
class MockDirectory extends _i1.Mock implements _i2.Directory {
  ...
  _i4.Future<_i2.Directory> create({bool? recursive = false}) =>
      (super.noSuchMethod(
        ...
        returnValue: _i4.Future<_i2.Directory>.value(_FakeDirectory_2(
          this,
          Invocation.method(
            #create,
            [],
